...
public class Ch {
    ...
    public static void menuPrincipal() {
        String cadena = "";
        cadena += "\nMENU PRINCIPAL | EXAMEN 1T - 2ºDAM\n";
        cadena += "==================================\n\n";
        cadena += "1. ACTIVIDAD 1: Contar caracter indicado en un txt\n";
        cadena += "2. ACTIVIDAD 2: Mostrar información no txt\n";
        cadena += "3. ACTIVIDAD 3: Volcado XML -> JSON\n\n";
        cadena += "0. SALIR :)\n";
